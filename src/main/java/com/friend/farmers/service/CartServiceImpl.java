...
import com.friend.farmers.models.CartItem;
import com.friend.farmers.models.Product;
import com.friend.farmers.payload.CartDTO;
import com.friend.farmers.payload.ProductDTO;
import com.friend.farmers.respository.CartItemRepository;
import com.friend.farmers.respository.CartRepository;
import com.friend.farmers.respository.ProductRepository;
...
public class CartServiceImpl implements CartService {
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        if (newQuantity == 0){
            ...
            cart.setTotalAmount(cart.getTotalAmount() + (cartItem.getPrice() * quantity));
            cartRepository.save(cart);
        }
