...
import com.friend.farmers.security.response.MessageResponse;
import com.friend.farmers.security.response.UserInfoResponse;
import com.friend.farmers.security.services.UserDetailsImpl;
...
//                encoder.encode(signUpRequest.getPassword()));
        ...
        if (strRoles == null) {
            //No roles are provided making them as a default user
